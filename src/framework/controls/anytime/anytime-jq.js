    ...
    __pickers[id] =
    {
        ...
        askOffset: function( event )
        {
            ...
            if ( this.oDiv.outerHeight(true) > this.div.height() )
            {
                ...
                this.oBody.css({
                    height:
                    String(this.div.height()-(this.oDiv.outerHeight(true)+this.oBody.outerHeight(false)))+'px',
...
//
// if(
//     window.location.hostname.length&&(window.location.hostname!='dev.ama3.com')
//     &&(window.location.hostname!='www.ama3.com')
//     &&(!/best.*picker.com$/.test(window.location.hostname))
// )
//     alert('REMOVE THE LAST LINE FROM anytime.5.1.2.js!');
